...
There can be as many spaces around the tokens as the user feels like,
...
Overall, the software is intended to be used as a stand-alone command-line
application. However, with only some minor modifications, it can be turned
into a tool and a back-end engine for any other application.
